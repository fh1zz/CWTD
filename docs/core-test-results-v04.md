...
Unity 2022.3.47f1 / 2026-09-06 07:12:53Z

```text
核心回归通过：38 组，18657 项断言。
通过：公开合同与纯 System 依赖
通过：归一化路径、14 地块与道路避让
通过：赠送宠物、编队限定与输入复制
通过：池内九合三、无连跳与最高等级
...
通过：相同种子重现和时间分片一致
模拟：glade seed=7 Won 波=6 HP=20 击杀=60 金币=93 时长=141.009689秒
模拟：glade seed=19 Won 波=6 HP=20 击杀=60 金币=93 时长=152.306931秒
模拟：glade seed=41 Won 波=6 HP=20 击杀=60 金币=93 时长=145.941818秒
模拟：brook seed=7 Won 波=8 HP=20 击杀=112 金币=138 时长=276.7099秒
模拟：brook seed=19 Won 波=8 HP=20 击杀=112 金币=138 时长=282.22522秒
模拟：brook seed=41 Won 波=8 HP=20 击杀=112 金币=138 时长=257.897827秒
模拟：grove seed=7 Won 波=10 HP=16 击杀=168 金币=134 时长=456.1494秒
模拟：grove seed=19 Won 波=10 HP=10 击杀=166 金币=91 时长=432.305237秒
模拟：grove seed=41 Won 波=10 HP=16 击杀=169 金币=115 时长=417.3922秒
通过：三关九次普通策略模拟及完整胜败
自动技能专项通过：11组，347项断言。
